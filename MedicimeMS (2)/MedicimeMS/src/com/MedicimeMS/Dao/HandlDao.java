			...
			if(other3==0){
				if(other1==0&&other2==0){
					 prst=conn.prepareStatement("select i.InfoHandle,i.HandleName,i.InfoId,i.InfoContent,i.SubmitTime,i.InfoWay,h.HospitalName,it.TypeName,u.Name " +
					    		...
					    		"where i.InfoTypeId=it.InfoTypeId and i.HospitalId=h.HospitalId and i.UserId=u.UserId and i.InfoHandle=''");
				}
				else if(other1!=0&&other2!=0){
					prst=conn.prepareStatement("select i.InfoHandle,i.HandleName,i.InfoId,i.InfoContent,i.SubmitTime,i.InfoWay,h.HospitalName,it.TypeName,u.Name " +
				    		"from T_Info as i,T_InfoType as it,T_Hospital as h,T_User as u " +
				    		"where i.InfoTypeId=it.InfoTypeId and i.HospitalId=h.HospitalId and i.UserId=u.UserId and i.InfoHandle='' and i.UserId="+other1+" and i.HospitalId="+other2+"");
				}
				else if(other1!=0&&other2==0){
					prst=conn.prepareStatement("select i.InfoHandle,i.HandleName,i.InfoId,i.InfoContent,i.SubmitTime,i.InfoWay,h.HospitalName,it.TypeName,u.Name " +
				    		"from T_Info as i,T_InfoType as it,T_Hospital as h,T_User as u " +
				    		"where i.InfoTypeId=it.InfoTypeId and i.HospitalId=h.HospitalId and i.UserId=u.UserId and i.InfoHandle='' and i.UserId="+other1+"");
				}
				else if(other1==0&&other2!=0){
					prst=conn.prepareStatement("select i.InfoHandle,i.HandleName,i.InfoId,i.InfoContent,i.SubmitTime,i.InfoWay,h.HospitalName,it.TypeName,u.Name " +
				    		"from T_Info as i,T_InfoType as it,T_Hospital as h,T_User as u " +
				    		"where i.InfoTypeId=it.InfoTypeId and i.HospitalId=h.HospitalId and i.UserId=u.UserId and i.InfoHandle='' and i.HospitalId="+other2+" ");
				}
			}
			else{
				if(other1==0&&other2==0){
					prst=conn.prepareStatement("select i.InfoHandle,i.HandleName,i.InfoId,i.InfoContent,i.SubmitTime,i.InfoWay,h.HospitalName,it.TypeName,u.Name " +
				    		"from T_Info as i,T_InfoType as it,T_Hospital as h,T_User as u " +
				    		"where i.InfoTypeId=it.InfoTypeId and i.HospitalId=h.HospitalId and i.UserId=u.UserId and i.InfoHandle='' and i.InfoTypeId="+other3+"");
				}
				else if(other1!=0&&other2!=0){
					prst=conn.prepareStatement("select i.InfoHandle,i.HandleName,i.InfoId,i.InfoContent,i.SubmitTime,i.InfoWay,h.HospitalName,it.TypeName,u.Name " +
				    		"from T_Info as i,T_InfoType as it,T_Hospital as h,T_User as u " +
				    		"where i.InfoTypeId=it.InfoTypeId and i.HospitalId=h.HospitalId and i.UserId=u.UserId and i.InfoHandle='' and i.UserId="+other1+" and i.HospitalId="+other2+" and i.InfoTypeId="+other3+"");
				}
				else if(other1!=0&&other2==0){
					prst=conn.prepareStatement("select i.InfoHandle,i.HandleName,i.InfoId,i.InfoContent,i.SubmitTime,i.InfoWay,h.HospitalName,it.TypeName,u.Name " +
				    		"from T_Info as i,T_InfoType as it,T_Hospital as h,T_User as u " +
				    		"where i.InfoTypeId=it.InfoTypeId and i.HospitalId=h.HospitalId and i.UserId=u.UserId and i.InfoHandle='' and i.UserId="+other1+"  and i.InfoTypeId="+other3+"");
				}
				else if(other1==0&&other2!=0){
					prst=conn.prepareStatement("select i.InfoHandle,i.HandleName,i.InfoId,i.InfoContent,i.SubmitTime,i.InfoWay,h.HospitalName,it.TypeName,u.Name " +
				    		"from T_Info as i,T_InfoType as it,T_Hospital as h,T_User as u " +
				    		"where i.InfoTypeId=it.InfoTypeId and i.HospitalId=h.HospitalId and i.UserId=u.UserId  and i.InfoHandle='' and i.HospitalId="+other2+" and i.InfoTypeId="+other3+"");
				}
		...
		try {
			if(other3==0){
				if(other2==0){
					 prst=conn.prepareStatement("select i.InfoHandle,i.HandleName,i.InfoId,i.InfoContent,i.SubmitTime,i.InfoWay,h.HospitalName,it.TypeName,u.Name " +
					    		"from T_Info as i,T_InfoType as it,T_Hospital as h,T_User as u " +
					    		"where i.InfoTypeId=it.InfoTypeId and i.HospitalId=h.HospitalId and i.UserId=u.UserId and i.InfoHandle='' and i.UserId="+userid+"");
				}
				else if(other2!=0){
					prst=conn.prepareStatement("select i.InfoHandle,i.HandleName,i.InfoId,i.InfoContent,i.SubmitTime,i.InfoWay,h.HospitalName,it.TypeName,u.Name " +
				    		"from T_Info as i,T_InfoType as it,T_Hospital as h,T_User as u " +
				    		"where i.InfoTypeId=it.InfoTypeId and i.HospitalId=h.HospitalId and i.UserId=u.UserId and i.InfoHandle='' and i.UserId="+userid+" and i.HospitalId="+other2+"");
				}
				...
				if(other2==0){
					prst=conn.prepareStatement("select i.InfoHandle,i.HandleName,i.InfoId,i.InfoContent,i.SubmitTime,i.InfoWay,h.HospitalName,it.TypeName,u.Name " +
				    		"from T_Info as i,T_InfoType as it,T_Hospital as h,T_User as u " +
				    		"where i.InfoTypeId=it.InfoTypeId and i.HospitalId=h.HospitalId and i.UserId=u.UserId and i.InfoHandle='' and i.InfoTypeId="+other3+" and i.UserId="+userid+"");
				}
				else if(other2!=0){
					prst=conn.prepareStatement("select i.InfoHandle,i.HandleName,i.InfoId,i.InfoContent,i.SubmitTime,i.InfoWay,h.HospitalName,it.TypeName,u.Name " +
				    		"from T_Info as i,T_InfoType as it,T_Hospital as h,T_User as u " +
				    		"where i.InfoTypeId=it.InfoTypeId and i.HospitalId=h.HospitalId and i.UserId=u.UserId and i.InfoHandle='' and i.UserId="+userid+" and i.HospitalId="+other2+" and i.InfoTypeId="+other3+"");
				}
