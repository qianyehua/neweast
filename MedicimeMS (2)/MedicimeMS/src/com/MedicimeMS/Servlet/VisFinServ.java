...
public class VisFinServ extends HttpServlet {
...
//		System.out.println(type);
		...
		int row=1 ;
		try {
			arry=a.findvisi2(pag,other1,other2,value,sdate,edate);
//			System.out.println(arry);
			ob=new JSONObject();
	    	 ob.put("total",a.findvisi(other1,other2,value,sdate,edate).size());
	    	 ob.put("rows", arry);
		} catch (Exception e) {
			...
			try {
				arry=a.findvisiB2(pag,userid, other2, value, sdate, edate);
				ob=new JSONObject();
		    	 ob.put("total",a.findvisiB(userid,other2,value,sdate,edate).size());
		    	 ob.put("rows", arry);
