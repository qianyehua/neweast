...
(function($) {
    ...
    $.fn.treeview = function(settings) {
        var dfop =
            {
                ...
                datatype: "json",
                url: false,
                cbiconpath: imageServer+"/images/icons/",
        ...
        function buildnode(nd, ht, deep, path, isend) {
            ...
            if (deep == 1) {
                ht.push("<img class='bbit-tree-icon' src='"+imageServer+"/images/s.gif'/>");
            }
            else if (deep > 1) {
                ht.push("<img class='bbit-tree-icon' src='"+imageServer+"/images/s.gif'/>");
                for (var j = 1; j < deep; j++) {
                    ht.push("<img class='bbit-tree-elbow-line' src='"+imageServer+"/images/s.gif'/>");
                }
            }
            ht.push("</span>");
            //img
            ...
            ht.push("<img class='bbit-tree-ec-icon ", cs.join(" "), "' src='"+imageServer+"/images/s.gif'/>");
            ht.push("<img class='bbit-tree-node-icon' src='"+imageServer+"/images/s.gif'/>");
            //checkbox
